const leftColumn = document.querySelector(".asb19__product-info-left");
  const rightColumn = document.querySelector(".asb19__product-info-scroll");
  const items = document.querySelectorAll(".asb19__product-info-scroll > li");
